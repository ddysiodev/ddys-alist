...
$PackageDir = Join-Path $Root "package\ddys-alist"
$Zip = Join-Path $ReleaseDir ("ddys-alist-v{0}.zip" -f $Version)
...
$excludeSegments = @(".git", ".wrangler", "node_modules", "dist", "build", "coverage", "package", "bin-output", "obj")
